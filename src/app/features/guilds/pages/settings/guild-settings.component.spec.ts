...
const setup = (guildId: string | null, user: User | null = null) => {
  ...
  const fixture = TestBed.createComponent(GuildSettingsComponent);
...
describe('GuildSettingsComponent', () => {
  ...
  describe('breadcrumbs()', () => {
    ...
    it('sets i18nKey on the last item for the settings label', () => {
      const crumbs = setup('g1').breadcrumbs();

      expect(crumbs.at(-1)?.i18nKey).toBe('sidenav.guild.settings');
    });
