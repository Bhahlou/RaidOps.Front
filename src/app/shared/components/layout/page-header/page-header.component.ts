...
import { ManualHelpLinkComponent } from '../../header/manual-help-link/manual-help-link.component';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, TranslocoPipe, DiscordIconComponent, ManualHelpLinkComponent],
