...
If a channel shows a ⚠️ warning, the bot doesn't currently have permission to post messages there — you can still select it (e.g. ahead of fixing its permissions), but no message will be posted until the bot's access is corrected.
